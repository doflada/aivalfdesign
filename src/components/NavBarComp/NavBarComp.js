...
const NavBarComp = () => {
  return (
    <nav id = "nav-id" className="f6 fw6 mr3 flex tc tracked">
            ...
            <a className="linkuri link grow pa2 br3 black mr3" href="#schi-id" title="Schite">Bijuterii</a>
            <a className="linkuri link grow pa2 br3 black mr3" href="#schi-id" title="Schite">Cadouri</a>
            <a className="linkuri link grow pa2 br3 black mr3" href="#schi-id" title="Agende personalizate">Agende personalizate</a>
            <a className="linkuri link grow pa2 br3 black mr1" href="#about-id" title="Despre">Despre mine</a>
    </nav>
  )
}
